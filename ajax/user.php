...
// );
        ...
        $data=$con->myQuery("SELECT CONCAT(first_name,' ',middle_name,' ',last_name) as name,username,email,contact_no,employee_no,location,title,department,id,is_active FROM qry_users {$where} {$order} {$limit}",$inputs)->fetchAll(PDO::FETCH_ASSOC);
