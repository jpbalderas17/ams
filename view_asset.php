...
<div class='content-wrapper'>
    <section class='content-header'>
        <h1>
            View Asset <?php echo htmlspecialchars($asset['asset_name'])?> (<?php echo htmlspecialchars($asset['category'])?>)
        </h1>
    </section>
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <li>
                                        <?php
                                            ...
                                            if(empty($asset['check_out_date']) || $asset['check_out_date']=="0000-00-00" || $asset['check_out_date']=="00/00/00"):
                                        ?>
